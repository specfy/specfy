...
ALTER TABLE "Activities"
  DROP COLUMN "targetComponentId",
  DROP COLUMN "targetDocumentId",
  ADD COLUMN "targetBlobId" VARCHAR(15);

-- AddForeignKey
ALTER TABLE "Activities"
  ADD CONSTRAINT "Activities_targetBlobId_fkey" FOREIGN KEY ("targetBlobId") REFERENCES "Blobs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
