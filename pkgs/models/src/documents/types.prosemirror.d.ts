...
export interface MarkDiff {
    type: 'diffMark';
    attrs: {
        type: 'added' | 'formatting' | 'removed' | 'unchanged';
    };
}
export type Marks = MarkDiff | {
    type: 'link';
    attrs: {
        href: string;
        target: string;
...
export type BlockLevelOne = BlockBanner | BlockBulletList | BlockCodeBlock | BlockDocument | BlockHeading | BlockHorizontalRule | BlockImage | BlockOrderedList | BlockParagraph | BlockQuote | BlockStep | BlockTable | BlockTaskList | BlockVote;
export type Blocks = BlockBanner | BlockBulletList | BlockCodeBlock | BlockDocument | BlockHardBreak | BlockHeading | BlockHorizontalRule | BlockImage | BlockListItem | BlockOrderedList | BlockParagraph | BlockQuote | BlockStep | BlockTable | BlockTableCell | BlockTableHeader | BlockTableRow | BlockTaskItem | BlockTaskList | BlockText | BlockVote | BlockVoteItem;
export type BlocksWithContent = BlockBanner | BlockBulletList | BlockCodeBlock | BlockHeading | BlockListItem | BlockOrderedList | BlockParagraph | BlockQuote | BlockStep | BlockTable | BlockTableCell | BlockTableHeader | BlockTableRow | BlockTaskItem | BlockTaskList | BlockVote | BlockVoteItem;
