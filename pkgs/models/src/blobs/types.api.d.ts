...
import type { DBBlob, DBBlobComponent, DBBlobDocument, DBBlobProject } from './types.js';
...
export type ApiBlobWithPrevious = ApiBlobComponent | ApiBlobDocument | ApiBlobProject;
