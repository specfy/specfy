        ...
        datasets: [
          {
            ...
            data: [106.8, 69, 0.9],
            backgroundColor: 'hsl(206 86.9% 65.3%)',
          },
        ],
      }}
    />
...
<div className="flex gap-8 mb-8">
  <table className="border rounded-md text-sm h-full">
    ...
    <tbody>
      ...
      <tr><td className="py-2 px-4">Image Size </td><td className="px-4">2.48GB</td><td className="px-4">1.61GB (-36%)</td></tr>
    </tbody>
  </table>
      ...
      data={{
        ...
        datasets: [
          ...
          },
          {
            label: 'Slim image',
            data: [57.5, 45],
            backgroundColor: 'hsl(131 58.1% 76.3%)',
          },
          {
            label: 'Multi-Staged',
            data: [65.2, 50],
